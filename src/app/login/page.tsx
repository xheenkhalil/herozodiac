...
import { FontAwesomeIcon, faCompass, faLock, faEnvelope } from '@/components/ui/Icons';
      ...
      <div className="max-w-md w-full bg-white border border-stone-200 rounded-2xl p-8 sm:p-10 shadow-lg relative overflow-hidden">
        ...
        <div className="text-center mb-8 relative z-10">
          ...
          <p className="text-xs text-stone-500">
            Sign in to access your saved birth charts and assessment results.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4 relative z-10">
          ...
          <div>
            <div className="flex items-center justify-between mb-1.5">
              ...
              <a href="#" className="text-xs text-[#7B1123] hover:underline font-medium">
                Forgot?
              </a>
            </div>
            <div className="relative">
        ...
        <div className="mt-8 pt-6 border-t border-stone-100 text-center text-xs text-stone-500">
          ...
          <Link href="/register" className="font-bold text-[#7B1123] hover:underline">
            Create Profile
          </Link>
        </div>
